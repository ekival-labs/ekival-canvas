...
// TakerConfirmAdaBuyRemitHandler lets the taker confirm remit for an ADA buy order.
func TakerConfirmAdaBuyRemitHandler(c *fiber.Ctx) error {
	...
	cborString, txHash, err := ada_p2p_buy.TakerConfirmRemit(orderInfo, config.GetAdaP2PBuyAdminWallet())
